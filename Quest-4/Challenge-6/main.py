...
print(f"Post this XDR @ SQ Xdr Box: {xdr}") #(context) in quest 4 you had to submit every transaction thought the quest box, that would sign it with with a hidden key
